(function(root, factory) {
    ...
    Formatter = (function(superClass) {
        ...
        Formatter.prototype._init = function() {
            this.editor = this._module;
            this._allowedTags = $.merge(['scrollto', 'br', 'span', 'a', 'img', 'b', 'strong', 'i', 'strike', 'u', 'font', 'p', 'ul', 'ol', 'li', 'blockquote', 'pre', 'code', 'h1', 'h2', 'h3', 'h4', 'hr'], this.opts.allowedTags);
            ...
            contents.each((function(_this) {
                return function(i, node) {
                    ...
                    if (node.nodeType === 3) {
                        ...
                        if (lineBreak && i < contents.length - 1 && $node.is('scrollto,br, p, div, li,tr, pre, address, artticle, aside, dl, figcaption, footer, h1, h2,h3, h4, header')) {
                            return result += '\n';
                        }
                    }
                };
    ...
    Util = (function(superClass) {
        ...
        Util.prototype.isEmptyNode = function(node) {
            var $node;
            $node = $(node);
            return $node.is(':empty') || (!$node.text() && !$node.find(':not(br,scrollto , span, div, b, a, strong, i, strike, font, u)').length);
        };
        ...
        Util.prototype.blockNodes = ["div", "scrollto", "p", "ul", "ol", "li", "blockquote", "hr", "pre", "h1", "h2", "h3", "h4", "h5", "table"];
    ...
    Indentation = (function(superClass) {
        ...
        Indentation.prototype.indentBlock = function(blockEl) {
            ...
            } else if ($blockEl.is('scrollto ,p, h1, h2, h3, h4')) {
            ...
            img.onload = (function(_this) {
                return function() {
                    ...
                    let dataAPI = {
                        ...
                        // console.log(dataAPI)
                    connectApi('master/uploadFile', { type: 'save', data: dataAPI, dataoption: 0 }, 'showInutSettingGroup1', function(output) {
                        console.log(output)
                        if (output.status == 200) {
                            // let file__ = `${output.data[0].path}${output.data[0].fileName}`
                            let file__ = `https://${YOURDOMAIN}/src/img/setting/${output.data[0].fileName}`

                            $img.attr({
                                src: file__,
                                // width: width,
                                // height: height,
                                id: `img-${output.data[0].fileName}`,
    ...
    AlignmentButton = (function(superClass) {
        ...
        AlignmentButton.prototype.htmlTag = 'scrollto,p, h1, h2, h3, h4, td, th';
