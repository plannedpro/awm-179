function paginator(config) {
    ...
    box = config.box;
    box.setAttribute("id", `boxbox-${config.table.id}`);
    ...
    if (typeof config.box_mode == "function") {
        ...
        if (config.box_mode == "list") {
            page_box.className = "pagination pagination-sm m-0 float-right";
        }
    ...
    if (!(typeof config.page_options == "boolean" && !config.page_options)) {
        ...
        select.classList.add('form-control', 'col-md-1', 'col-3', 'select-pagination');
    ...
    stat.classList.add('shownumdata-pagination');
