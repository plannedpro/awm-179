        ...
        <div class="row mb-2">
            ...
            <div class="col-md-6 text-right">
                <!-- <span style="" id="btnAddAccountAdmin"
                    onclick="addNewGroupDetail1('uploadblogsgroupDetail1','<?=$_GET['token']?>')"
                    class="badge badge-pill badge-success cursor-pointer"><i class="fas fa-plus"></i> เพิ่มบริการใหม่</span> -->
                ...
                <span onclick="getDataBlogsGroupDetail1('all')" class="badge badge-pill badge-secondary cursor-pointer"><i
