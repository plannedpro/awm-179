...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-md-6">
                <h1 class="m-0 text-dark">รายละเอียดหัวข้อ</h1>
                <small>
                รายละเอียดหัวข้อ
                </small>
            </div>
            <div class="col-md-6 text-right">
                <span style="" id="btnAddAccountAdmin"
                    onclick="addNewGroupDetail5('uploadblogsgroupDetail1','<?=$_GET['token']?>')"
                ...
                <span onclick="getDataBlogsGroupDetail5('all')" class="badge badge-pill badge-secondary cursor-pointer"><i
