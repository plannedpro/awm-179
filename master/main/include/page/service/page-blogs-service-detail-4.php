...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-md-6">
                <h1 class="m-0 text-dark">รายละเอียดแบรนด์</h1>
                <small>
                    รายละเอียดแบรนด์
                </small>
            </div>
            <div class="col-md-6 text-right">
                <span style="" id="btnAddAccountAdmin"
                    onclick="addNewGroupDetail4('uploadblogsgroupDetail1','<?=$_GET['token']?>')"
                    class="badge badge-pill badge-success cursor-pointer"><i class="fas fa-plus"></i> เพิ่มแบรนด์ใหม่</span>
                ...
                <span onclick="getDataBlogsGroupDetail4('all')" class="badge badge-pill badge-secondary cursor-pointer"><i
