...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-md-6">
                <h1 class="m-0 text-dark">รายละเอียดบริการ </h1>
                <small>
                    รายละเอียดบริการ
                </small>
            </div>
            <div class="col-md-6 text-right">
                <span style="" id="btnAddAccountAdmin"
                    onclick="addNewGroupDetail3('uploadblogsgroupDetail2','<?=$_GET['token']?>')"
                    class="badge badge-pill badge-success cursor-pointer"><i class="fas fa-plus"></i> เพิ่มบทความรีวิวใหม่</span>
                ...
                <span onclick="getDataBlogsGroupDetail3('all')" class="badge badge-pill badge-secondary cursor-pointer"><i
                ...
                <div class="ui icon input mini">
                    ...
                    <i aria-hidden="true" onclick="InputSearchData('search','blogsgroupDetail1')"
