...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-md-6">
                <h1 class="m-0 text-dark">บทความ <i class="fas fa-caret-right"></i> จัดการหัวข้อบทความ</h1>
                <small>
                    ข้อมูลหัวข้อ
                </small>
            </div>
            <div class="col-md-6 text-right">
                <span style="" id="btnAddAccountAdmin"
                    onclick="addNewGroupManage2('uploadblogsgroupmanage2')"
                    class="badge badge-pill badge-success cursor-pointer"><i class="fas fa-plus"></i> เพิ่มหัวข้อบทความใหม่</span>
                ...
                <span onclick="getDatablogsgroupmanage2('all')" class="badge badge-pill badge-secondary cursor-pointer"><i
