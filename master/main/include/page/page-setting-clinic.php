        ...
        <div class="row">
            ...
            <!-- <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <iframe src="https://lyftclinic.plannedpro.co/contact/" height="500" width="100%" title="Iframe Example"></iframe>
                    </div>
                </div>
            </div> -->
